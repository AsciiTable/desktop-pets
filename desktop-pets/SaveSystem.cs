...
namespace desktop_pets
{
    class SaveSystem
    {
        ...
        public static Pet LoadRiiTheCat() {
            ...
            Animation idle_v0 = new Animation(new Bitmap("Art/cat/idle_v0.png"), 64, 64, 1);
            Animation idle_v1 = new Animation(new Bitmap("Art/cat/idle_v1.png"), 64, 64, 6);
            ...
            Animation walk_v0 = new Animation(new Bitmap("Art/Cat/walk_v0.png"), 64, 64, 6);
            Animation walk_v1 = new Animation(new Bitmap("Art/Cat/walk_v1.png"), 64, 64, 6);
